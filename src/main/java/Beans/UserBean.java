...
public class UserBean {
    ...
    @Path("/signup")
    @POST
    public void addUser(@FormParam("login") String login, @FormParam("password") String password, @FormParam("mail") String email, @Context HttpServletResponse resp, @Context HttpServletRequest req) {
        try {
...
//    http://localhost:8080/demo/zhopa/usr/helloworld
    @Path("/helloworld")
    @GET
